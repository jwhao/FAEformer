...
from models import models_vit_fsl_plus_pos_local_weight
from models import models_vit_fsl_plus_pos_local_weight_support_proto
...
log_path = os.path.join(log_path,'save_train_plus_pos_local_{}_multi_loss_weight/{}/shot-{}-{}-{}'.format(
                            params.k,params.dataset,params.n_shot,params.name,time.strftime('%Y-%m-%d_%H-%M-%S', time.localtime())))
...
def main():
    ...
    model = models_vit_fsl_plus_pos_local_weight_support_proto.__dict__[params.model](
        num_classes=0,
