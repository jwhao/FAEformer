...
from models import models_vit_fsl_plus_pos_local_conv_support_proto
...
parser.add_argument('--conv-type', default='k2',type=str,choices=['k2','k3','k4','k5','k7','k3d3','k3d2','kds','rd']) 
...
log_path = os.path.join(log_path,'save_train_plus_pos_local_{}_multi_loss_weight_conv/{}/shot-{}-{}-{}'.format(
...
def main():
    ...
    model = models_vit_fsl_plus_pos_local_conv_support_proto.__dict__[params.model](
        num_classes=0,
