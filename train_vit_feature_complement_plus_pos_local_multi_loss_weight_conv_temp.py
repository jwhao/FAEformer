...
parser.add_argument('--conv-type', default='linear',type=str,choices=['k2','k3','k4','k5','k7','k3d3','k3d2','kds','rd',
...
log_path = os.path.join(log_path,'save_train_plus_pos_local_{}_multi_loss_weight_conv_temp/{}/shot-{}-{}-W{}-{}-{}'.format(
